...
namespace Movement
{
    ...
    public class Mover : MonoBehaviour, IAction, ISaveable
    {
        ...
        private PlayerConversant playerConversant; // Reference to PlayerConversant
        ...
        private void Update()
        {
            ...
            if (playerConversant != null && playerConversant.IsActive())
            {
        ...
        {
            if (playerConversant != null && playerConversant.IsActive()) return; // Prevent movement during dialogue
...
// Reset the velocity to stop any movement
            navMeshAgent.velocity = Vector3.zero; 
 
            // Update the animation to stop the player's legs from moving
            if (animator != null)
            {
